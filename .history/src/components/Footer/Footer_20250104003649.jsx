...
const Footer = () => {
    return (
        <footer className=" bg-white pt-10 mt-5" >
          ...
          <h1 className="text-2xl font-bold">Study Hive</h1>
          <p>StudyHive is an innovative online platform designed to enhance group study experiences, helping students <br/> collaborate, organize, and track their learning efficiently. </p>
          </div>
