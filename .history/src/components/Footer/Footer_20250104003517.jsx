...
const Footer = () => {
    return (
        <footer className=" bg-white pt-10 mt-5" >
          ...
          <p>StudyHive is an innovative online platform designed to enhance group study experiences, helping students collaborate, organize, and track their learning efficiently. </p>
          </div>
